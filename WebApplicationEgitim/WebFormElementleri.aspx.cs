...
namespace WebApplicationEgitim
{
    public partial class WebFormElementleri : System.Web.UI.Page
    {
        ...
        {
            // windows forms daki form açılırken db den verileri çekip ekrana yollamak için kullanıdığımız form load metodu web de pageload olarak aynı işlem için kullanılıyor.

...
namespace Ders13Enumlar
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Meyveler : Armut = {a}, Elma = {b}, Çilek = {c}"); //değişkenlere atadığımız için değerlerini alırız.
            Console.WriteLine($"Meyveler : Armut = {Meyveler.Armut}, Elma = {Meyveler.Elma}, Çilek = {Meyveler.Çilek}"); //direkt olarak isimlerini yazar.
        ...
        enum Meyveler : int
        {
            Elma = 3, Armut = 7, Çilek = 1 // sıra numarası verilebilir. 
        }
    }
}
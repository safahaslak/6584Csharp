...
namespace WindowsFormsEFDBFirst
{
    public partial class Form1 : Form
    {
        ...
        {
            // EntityFramework ado net deki gibi sql kodları yazmadan veritabanı crud işlemlerini yapabilmemizi sağlayan bir kütüphanedir. Projeye sonradan Nuget package manager aracılığıyla eklenir.
            // Projeye EntityFramework ekleyebilmek için projeye sağ tıklayıp açılan menüden nuget package manager 1 seçip açılan pencerenin browse seçeneğine basıp oradan entity framework paketini seçip yükle butonu ile açılan onay pencerelerine onay vermemiz gerekir.
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                StokMiktari = int.Parse(txtStokMiktari.Text), UrunAdi = txtUrunAdi.Text, UrunFiyati = decimal.Parse(txtUrunFiyati.Text)
            };
        ...
        private void dgvUrunler_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtUrunFiyati.Text = urun.UrunFiyati.ToString(); // db den gelen üründeki bilgileri textbox lara doldur.
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            int sonuc = tablolar.SaveChanges(); // silme işlemlerini db ye işledik yoksa silme gerçekleşmez!

...
namespace MVCEgitim.Controllers
{
    public class MVC10CookieController : Controller
    {
        ...
        {
            HttpCookie cookie = new HttpCookie("username", "Admin") // adı username olan ve admin verisini taşıyan bir çerez oluşturduk.
            {
        ...
        public ActionResult CookieOku()
        {
            if (HttpContext.Request.Cookies["username"] != null)
            {
                ...
                // uygulamanın oluşturduğu cookie yi okuyup tempdata ile ekrana yolluyoruz.
            }
        ...
        public ActionResult CookieSil()
        {
            ...
            TempData["mesaj2"] = "<div class='alert alert-danger'>Cookie Silindi!</div>";
            return RedirectToAction("Index");
        }
    }
}
